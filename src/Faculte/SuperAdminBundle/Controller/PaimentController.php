...
class PaimentController extends Controller
{
    public function ajouterPaimentAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($request->isMethod('POST')) {
                ...
                return $this->redirect($this->generateUrl('faculte_super_admin_liste_paiment'));
            }
        }


        return $this->render('FaculteSuperAdminBundle:Paiment:ajouter.html.twig', array(
    ...
    public function listePaimentAction()
    {
        ...
        return $this->render('FaculteSuperAdminBundle:Paiment:liste.html.twig', array('Paiment' => $paiment));
    ...
    public function modifierPaimentAction($idPm, Request $request)
    {
        ...
        return $this->render('FaculteSuperAdminBundle:Paiment:modifier.html.twig', array(
    ...
    public function suitPaimentAction($idPm)
    {
        $em = $this->getDoctrine()->getManager();
        $paiment = $em->getRepository('FaculteAdminBundle:Paiment')->findOneById($idPm);
        return $this->render('FaculteSuperAdminBundle:Paiment:suit.html.twig', array('Paiment' => $paiment));
    ...
    public function renderactivitesAction(Request $request)
    {
            ...
            return $this->render('FaculteSuperAdminBundle:Paiment:renderactivites.html.twig',array('adherents'=>$adherent,'paiment'=>$paiment));
        }
