 ...
 * @ORM\Table(name="galeriepersonnel")
 * @ORM\Entity(repositoryClass="Faculte\AdminBundle\Repository\GaleriepersonnelRepository")
 */
class Galeriepersonnel
{
    /**
     * @var int
     *
    ...
    public function getTmpUploadPathFileRootDir() {
        // the absolute directory path where uploaded documents should be saved
        return dirname(__FILE__). '/../../../../web/files/galeriespersonnel/';
    }
