...
class ClientController extends Controller
{
    public function ajouterClientAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($request->isMethod('POST')) {
                ...
                return $this->redirect($this->generateUrl('faculte_admin_liste_client'));
            }
        }


        return $this->render('FaculteAdminBundle:Client:ajouter.html.twig', array(
    ...
    public function listeClientAction()
    {
        ...
        return $this->render('FaculteAdminBundle:Client:liste.html.twig', array('Client' => $client));
    ...
    public function modifierClientAction($idClt, Request $request)
    {
        ...
        return $this->render('FaculteAdminBundle:Client:modifier.html.twig', array(
    ...
    public function suitClientAction($idClt)
    {
        $em = $this->getDoctrine()->getManager();
        $client = $em->getRepository('FaculteAdminBundle:Client')->findOneById($idClt);
        return $this->render('FaculteAdminBundle:Client:suit.html.twig', array('Client' => $client));
