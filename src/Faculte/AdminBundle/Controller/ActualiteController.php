...
class ActualiteController extends Controller
{
    public function ajouterActualiteAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($request->isMethod('POST')) {
                ...
                return $this->redirect($this->generateUrl('faculte_admin_liste_actualite'));
            }
        }


        return $this->render('FaculteAdminBundle:Actualite:ajouter.html.twig', array(
    ...
    public function listeActualiteAction()
    {
        ...
        return $this->render('FaculteAdminBundle:Actualite:liste.html.twig', array('Actualite' => $actualite));
    ...
    public function modifierActualiteAction($idAct, Request $request)
    {
        ...
        return $this->render('FaculteAdminBundle:Actualite:modifier.html.twig', array(
    ...
    public function suitActualiteAction($idAct)
    {
        $em = $this->getDoctrine()->getManager();
        $actualite = $em->getRepository('FaculteAdminBundle:Actualite')->findOneById($idAct);
        return $this->render('FaculteAdminBundle:Actualite:suit.html.twig', array('Actualite' => $actualite));
