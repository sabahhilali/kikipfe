...
class ExerciceController extends Controller
{
    public function ajouterExerciceAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($request->isMethod('POST')) {
                ...
                return $this->redirect($this->generateUrl('faculte_admin_liste_exercice'));
            }
        }


        return $this->render('FaculteAdminBundle:Exercice:ajouter.html.twig', array(
    ...
    public function listeExerciceAction()
    {
        ...
        return $this->render('FaculteAdminBundle:Exercice:liste.html.twig', array('Exercice' => $exercice));
    ...
    public function modifierExerciceAction($idE, Request $request)
    {
        ...
        return $this->render('FaculteAdminBundle:Exercice:modifier.html.twig', array(
    ...
    public function suitExerciceAction($idE)
    {
        $em = $this->getDoctrine()->getManager();
        $exercice = $em->getRepository('FaculteAdminBundle:Exercice')->findOneById($idE);
        return $this->render('FaculteAdminBundle:Exercice:suit.html.twig', array('Exercice' => $exercice));
