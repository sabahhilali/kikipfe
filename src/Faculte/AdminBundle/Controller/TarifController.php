...
class TarifController extends Controller
{
    public function ajouterTarifAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($request->isMethod('POST')) {
                ...
                return $this->redirect($this->generateUrl('faculte_admin_liste_tarif'));
            }
        }


        return $this->render('FaculteAdminBundle:Tarif:ajouter.html.twig', array(
    ...
    public function listeTarifAction()
    {
        ...
        return $this->render('FaculteAdminBundle:Tarif:liste.html.twig', array('Tarif' => $tarif));
    ...
    public function modifierTarifAction($idT, Request $request)
    {
        ...
        return $this->render('FaculteAdminBundle:Tarif:modifier.html.twig', array(
    ...
    public function renderactivitesAction(Request $request)
    {
        ...
        return $this->render('FaculteAdminBundle:Tarif:renderactivites.html.twig',
