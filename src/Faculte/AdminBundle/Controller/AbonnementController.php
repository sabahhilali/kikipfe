...
class AbonnementController extends Controller
{
    public function ajouterAbonnementAction(Request $request)
    {
        ...
        return $this->render('FaculteAdminBundle:Abonnement:ajouter.html.twig', array(
    ...
    public function suitAbonnementAction($idAb)
    {
     ...
     public function renderactivitesAction(Request $request)
     {
             ...
             return $this->render('FaculteAdminBundle:Abonnement:renderactivites.html.twig',array('tarif'=>$tarif,'abonnement'=>$abonnement));
         }
