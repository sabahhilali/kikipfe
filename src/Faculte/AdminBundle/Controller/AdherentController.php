...
class AdherentController extends Controller
{
        ...
        if ($form->isSubmitted() && $form->isValid() && $form2->isSubmitted() && $form2->isValid()) {
            if ($request->getMethod() == 'POST') {
                ...
                try {
                    ...
                    return $this->render('FaculteAdminBundle:Adherent:ajouter.html.twig', array(
                        'form' => $form->createView(),'form2' => $form2->createView(),'errorUsername'=>$errorUsername,'errorEmail'=>$errorEmail
                    ));
                }


                return $this->redirect($this->generateUrl('faculte_admin_liste_adherent'));
            }
        }
    ...
    public function listeAdherentAction()
    {
        ...
        return $this->render('FaculteAdminBundle:Adherent:liste.html.twig', array('Adherent' => $adherent));
        ...
        if ($form->isSubmitted() && $form->isValid() && $form2->isSubmitted() && $form2->isValid()) {
            if ($request->isMethod('POST')) {
                ...
                try {
                    ...
                    return $this->render('FaculteAdminBundle:Adherent:modifier.html.twig', array(
                        'form' => $form->createView(),'form2' => $form2->createView(),'Adherent'=>$Adherent,'errorUsername'=>$errorUsername,'errorEmail'=>$errorEmail
                    ));
                }
                return $this->redirect($this->generateUrl('faculte_admin_adherent'));
            }
        }
    ...
    public function suitAdherentAction($idAd)
    {
        $em = $this->getDoctrine()->getManager();
        $adherent = $em->getRepository('FaculteAdminBundle:Adherent')->findOneById($idAd);
        return $this->render('FaculteAdminBundle:Adherent:suit.html.twig', array('Adherent' => $adherent));
