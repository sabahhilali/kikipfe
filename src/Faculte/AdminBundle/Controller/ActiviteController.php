...
class ActiviteController extends Controller
{
    public function ajouterActiviteAction(Request $request)
    {
        ...
        return $this->render('FaculteAdminBundle:Activite:ajouter.html.twig', array(
    ...
    public function listeActiviteAction()
    {
        ...
        return $this->render('FaculteAdminBundle:Activite:liste.html.twig', array('Activite' => $activite));
    ...
    public function suitActiviteAction($idA)
    {
        $em = $this->getDoctrine()->getManager();
        $activite = $em->getRepository('FaculteAdminBundle:Activite')->findOneById($idA);
        return $this->render('FaculteAdminBundle:Activite:suit.html.twig', array('Activite' => $activite));
